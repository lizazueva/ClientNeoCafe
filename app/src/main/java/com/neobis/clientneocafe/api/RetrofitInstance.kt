...
import com.neobis.clientneocafe.utils.Constants.Companion.BASE_URL
    ...
    companion object{
        ...
        private class AuthorizationInterceptor: Interceptor {
            override fun intercept(chain: Interceptor.Chain): Response {
                ...
                val newRequest = if (requiresAuthorization(request)){
                    val token = com.neobis.clientneocafe.utils.Utils.access_token
        ...
        private fun requiresAuthorization(request: okhttp3.Request): Boolean {
            ...
            return path.endsWith("my-profile/")||
                    ...
                    path.contains("ordering/reorder-information/") && request.method == "GET"||
                    path.contains("ordering/reorder/") && request.method == "GET"
